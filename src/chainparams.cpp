...
public:
    CMainParams() {
        ...
        consensus.nMaxSizeBase = 2828427; // 2 * sqrt(2) MB
        consensus.nMaxSizeDoublings = 10;
        consensus.nActivateSizeForkMajority = 100; // 100% of hashpower to activate fork
        consensus.nSizeForkGracePeriod = 365*60*60*24; // one year grace period after activation
...
public:
    CTestNetParams() {
        ...
        consensus.nMaxSizeBase = 2828427; // 2 sqrt(2) MB
        consensus.nMaxSizeDoublings = 10;
        consensus.nActivateSizeForkMajority = 100; // 100 of 100 to activate fork
